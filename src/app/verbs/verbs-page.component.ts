...
@Component({ selector: 'app-verbs-page', standalone: true,
  ...
  template: `
    <div style="padding: 24px; max-width: 1000px; margin: 0 auto;">
      ...
      <mat-card *ngFor="let verb of verbs" style="margin-bottom: 8px;">
        <mat-card-content style="padding: 12px 16px;">
          <div style="display: flex; justify-content: space-between; align-items: center;">
            ...
            <span *ngIf="verb.tensesId || verb['tenses_id']" style="font-size: 0.8em; color: #4caf50;">
              <mat-icon style="font-size: 16px; vertical-align: middle;">check_circle</mat-icon> Conjugations available
            </span>
            <span *ngIf="!verb.tensesId && !verb['tenses_id']" style="font-size: 0.8em; color: #ff9800;">
      ...
      <p *ngIf="verbs.length === 0" style="text-align: center; color: #aaa; margin-top: 40px;">No verbs identified yet. Add vocabulary words tagged as verbs.</p>
    </div>
  `,
})
